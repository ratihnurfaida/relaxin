    ...
    <div style="font-family: 'Inter', sans-serif;">
        <div class="w-full bg-white border border-cyan-100 rounded-2xl p-8 shadow-xl shadow-cyan-600/10">
            ...
            <div class="text-center mb-6">
                <h1 class="text-2xl mb-0.5" style="font-family: 'Fraunces', serif; font-weight: 600; color: #155E75;">Buat Password Baru</h1>
                <p class="text-gray-500 text-base">Masukkan password baru untuk akun kamu.</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.store') }}" class="space-y-4">
                ...
                {{-- Input Password Baru --}}
                <div>
                    <label for="password" class="block text-base font-bold text-gray-700 mb-1.5">Password Baru</label>
                    <div class="relative">
                        <input
                            id="password"
                            type="password"
                ...
                <div>
                    ...
                    <input
                        ...
                        class="w-full rounded-xl border border-slate-200 bg-slate-50 px-3.5 py-2.5 text-base text-gray-800
                               focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 focus:bg-white
                               placeholder-gray-400 transition duration-150
                               @error('password_confirmation') border-rose-400 focus:ring-rose-400 @enderror"
                    >
