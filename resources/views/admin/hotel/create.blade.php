...
<div class="pt-24 pb-16 px-4 md:px-8 max-w-3xl mx-auto" style="font-family: 'Inter', sans-serif;">
    ...
    {{-- Header --}}
    <div class="mb-8">
        <a href="{{ route('admin.hotel.index') }}" class="inline-flex items-center gap-1.5 text-base text-primary hover:underline mb-3">
            ← Kembali ke daftar hotel
        </a>
        <h1 class="text-4xl" style="font-family: 'Fraunces', serif; font-weight: 600; color: #0F172A;">Tambah Hotel Baru</h1>
        <p class="text-slate-400 text-base mt-1">Isi informasi hotel dengan lengkap dan benar</p>
    </div>
    ...
    <div class="bg-white rounded-3xl shadow-cyan-lg p-8">
        <form method="POST" action="{{ route('admin.hotel.store') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            {{-- Deskripsi --}}
            <div>
                <label for="deskripsi" class="block text-base font-semibold text-slate-700 mb-1.5">Deskripsi <span class="text-rose">*</span></label>
                <textarea
                    id="deskripsi"
                    name="deskripsi"
                    rows="4"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label for="star_rating" class="block text-base font-semibold text-slate-700 mb-1.5">Rating Bintang <span class="text-rose">*</span></label>
                    <select id="star_rating" name="star_rating" class="w-full rounded-xl border border-slate-200 bg-ice-cyan/50 px-4 py-2.5 text-base focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary @error('star_rating') border-rose @enderror">
                ...
                <div>
                    ...
                    <input id="harga" type="number" name="harga" value="{{ old('harga') }}" required min="0" placeholder="cth. 500000" class="w-full rounded-xl border border-slate-200 bg-ice-cyan/50 px-4 py-2.5 text-base focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary placeholder:text-slate-300 @error('harga') border-rose @enderror" style="font-family: 'IBM Plex Mono', monospace;">
                ...
                <div class="md:col-span-2">
                    ...
                    <select id="id_area" name="id_area" class="w-full rounded-xl border border-slate-200 bg-ice-cyan/50 px-4 py-2.5 text-base focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary @error('id_area') border-rose @enderror" required>
