...
<section class="relative px-12 pt-32 pb-28 text-left bg-cover bg-center bg-no-repeat rounded-b-[40px] overflow-hidden"
    ...
    <div class="max-w-7xl mx-auto relative z-10 text-white">
        <span class="text-sm font-bold uppercase tracking-widest bg-cyan-400/10 px-4 py-1.5 rounded-full backdrop-blur-sm border border-cyan-400/20" style="color: #67E8F9; font-family: 'IBM Plex Mono', monospace;">
            Tentang RelaXin
        </span>
        <h1 class="text-4xl md:text-6xl mt-6 mb-4 max-w-2xl leading-tight" style="font-family: 'Fraunces', serif; font-weight: 600;">
            Platform Pemesanan Hotel<br>Terdepan di Kota Bandung
        </h1>
        <p class="text-cyan-100/90 text-lg md:text-xl max-w-xl leading-relaxed">
...
<section class="px-12 py-20 bg-slate-50 border-t border-b border-gray-100" style="font-family: 'Inter', sans-serif;">
    <div class="max-w-7xl mx-auto">
        <div class="text-center max-w-2xl mx-auto mb-16">
            <p class="text-sm font-bold uppercase tracking-widest mb-2" style="color: #0E7490; font-family: 'IBM Plex Mono', monospace;">Layanan &amp; Ekosistem</p>
            <h2 class="text-3xl md:text-4xl leading-tight" style="font-family: 'Fraunces', serif; font-weight: 600; color: #155E75;">Pertumbuhan RelaXin dalam Angka</h2>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div class="bg-white border border-gray-100 rounded-2xl p-6 shadow-md hover:shadow-lg transition-shadow">
                ...
                <h4 class="text-sm font-bold text-gray-400 uppercase tracking-wider mb-1">Mitra Akomodasi</h4>
                <div class="text-3xl md:text-4xl mb-2" style="font-family: 'IBM Plex Mono', monospace; font-weight: 600; color: #155E75;">500+</div>
                <p class="text-gray-500 text-sm leading-relaxed">Hotel pilihan, resort, villa, dan apartemen di seluruh penjuru Bandung.</p>
            </div>
            ...
            <div class="bg-white border border-gray-100 rounded-2xl p-6 shadow-md hover:shadow-lg transition-shadow">
                ...
                <h4 class="text-sm font-bold text-gray-400 uppercase tracking-wider mb-1">Pengguna Aktif</h4>
                <div class="text-3xl md:text-4xl mb-2" style="font-family: 'IBM Plex Mono', monospace; font-weight: 600; color: #155E75;">15K+</div>
                <p class="text-gray-500 text-sm leading-relaxed">Wisatawan lokal maupun interlokal yang memercayakan staycation mereka.</p>
            </div>
            ...
            <div class="bg-white border border-gray-100 rounded-2xl p-6 shadow-md hover:shadow-lg transition-shadow">
                ...
                <h4 class="text-sm font-bold text-gray-400 uppercase tracking-wider mb-1">Cakupan Destinasi</h4>
                <div class="text-3xl md:text-4xl mb-2" style="font-family: 'IBM Plex Mono', monospace; font-weight: 600; color: #155E75;">15+ Area</div>
                <p class="text-gray-500 text-sm leading-relaxed">Mulai dari pusat Braga, heritages Dago, hingga pegunungan sejuk Lembang.</p>
            </div>
            ...
            <div class="bg-white border border-gray-100 rounded-2xl p-6 shadow-md hover:shadow-lg transition-shadow">
                ...
                <h4 class="text-sm font-bold text-gray-400 uppercase tracking-wider mb-1">Keamanan Transparan</h4>
                <div class="text-3xl md:text-4xl mb-2" style="font-family: 'IBM Plex Mono', monospace; font-weight: 600; color: #155E75;">100% Aman</div>
                <p class="text-gray-500 text-sm leading-relaxed">Seluruh proses pembayaran diverifikasi secara otomatis dan instan.</p>
            </div>
        </div>
    </div>
</section>
